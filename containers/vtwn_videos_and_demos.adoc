...
.Verwenden Sie Trident für die Bereitstellung von persistentem Storage in VMware Tanzu - VMware Tanzu mit NetApp
video::8db3092b-3468-4754-b2d7-b01200fbb38d[panopto,width=360]
.Verwenden Sie Trident Protect zum Klonen von Anwendungen in VMware Tanzu - VMware Tanzu mit NetApp
video::01aff358-a0a2-4c4f-9062-b01200fb9abd[panopto,width=360]

NOTE: Diese Demos wurden als technische Vorschau mit Version 1.3.1 von TKG und Version 21.12 von Trident Protect aufgenommen. In der Supportmatrix finden Sie weitere offizielle unterstützte Versionen.
