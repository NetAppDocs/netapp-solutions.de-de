...
* Trident muss bereits auf jedem Tanzu Kubernetes-Cluster installiert und konfiguriert sein.
...
* Eine Standard-StorageClass, die für jedes Tanzu Kubernetes-Cluster mit Trident als Storage-bereitstellung konfiguriert ist.
