...
Alan Cowles und Nikhil Kulkarni, NetApp
...
Weitere Informationen zu Anthos finden Sie auf der Website von Anthos https://https://cloud.google.com/anthos/["Hier"^].
...
| Anthos Cluster auf VMware | Container-Orchestrierung | 1.11 


| Anthos auf Bare Metal | Container-Orchestrierung | 1.10 


| VMware vSphere | Datacenter-Virtualisierung | 6.7U3, 7.0U3 
|===
