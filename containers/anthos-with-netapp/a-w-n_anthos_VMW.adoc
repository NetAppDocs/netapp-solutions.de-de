...
image:a-w-n_anthos_vm_architecture.png["Fehler: Fehlendes Grafikbild"]
...
Die folgende Tabelle enthält Serverplattformen, die von NetApp und seinen Engineers von NetApp Partnern für die Validierung von Anthos Clustern auf VMware Implementierungen getestet wurden. Dabei handelt es sich um Lösungen wie die https://www.netapp.com/data-storage/flexpod/documentation/["NetApp FlexPod"^] Mit Cisco UCS Servern und der https://docs.netapp.com/us-en/hci/["NetApp HCI"^] Hybrid-Cloud-Infrastrukturplattform:
...
|===
Während der von NetApp durchgeführten Validierung der Anthos Ready Plattform wurde die Lab-Umgebung auf Basis des folgenden Diagramms aufgebaut, mit der wir mehrere implementierte Benutzer-Cluster sowie mehrere NetApp Storage-Systeme und Storage-Back-Ends testen konnten.

image:a-w-n_anthos_vmware_validation.png["Fehler: Fehlendes Grafikbild"]
