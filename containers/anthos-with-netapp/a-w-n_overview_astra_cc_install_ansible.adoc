...
. Um Astra Control Center mit Ansible-Playbooks zu implementieren, ist ein Ubuntu/RHEL-System erforderlich, auf dem Ansible installiert ist. Gehen Sie wie beschrieben vor https://["Hier"] Für Ubuntu und https://["Hier"] Für RHEL.
