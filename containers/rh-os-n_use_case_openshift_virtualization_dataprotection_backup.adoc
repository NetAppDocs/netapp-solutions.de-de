...
Bild::redhat_openshift_OADP_backup_image1.jpg[Backup abgeschlossen]
...
Bild::redhat_openshift_OADP_backup_image3.jpg[Schedule erstellt]

Backups werden gemäß diesem Zeitplan erstellt und können auf der Registerkarte Backup angezeigt werden.
Bild::redhat_openshift_OADP_backup_image4.jpg[Schedule erstellt]
