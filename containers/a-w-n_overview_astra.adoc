...
Die Installation und Konfiguration von Trident zur Unterstützung des Astra Control Centers finden Sie unter link:rh-os-n_overview_trident.html["Dieses Dokument an"^].
