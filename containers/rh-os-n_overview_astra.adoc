...
--
. Um Astra Control Center mit Ansible-Playbooks zu implementieren, benötigen Sie eine Ubuntu/RHEL-Maschine mit installiertem Ansible. Befolgen Sie die Anweisungen https://docs.netapp.com/us-en/netapp-solutions/automation/getting-started.html["Hier"] Für Ubuntu und RHEL.
...
link:rh-os-n_astra_register.html["Als Nächstes: Registrieren Sie Ihre Red hat OpenShift Cluster: Red hat OpenShift mit NetApp."]
