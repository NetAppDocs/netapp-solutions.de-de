...
+
image:redhat_openshift_image82.png["Beobachtbarkeit Homepage"]
...
+
image:redhat_openshift_image83.png["Pods Beobachten"]
...
+
image:redhat_openshift_image84.png["Beobachten Sie Nodes"]
...
+
image:redhat_openshift_image85.png["Cluster Beobachten"]
