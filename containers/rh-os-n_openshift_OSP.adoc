...
Weitere Informationen zu OSP finden Sie im https://["Red hat OpenStack Platform Website"^].
...
Informationen zum Konfigurieren von Affinitätsgruppen finden Sie unter https://["Wie konfiguriere ich Affinität und Antiaffinität für OpenStack Instanzen?"^].
