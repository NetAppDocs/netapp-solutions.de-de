...
image::a-w-n_anthos_controlplanev2_vm_architecture.png[A w a z anthos controlplanev2 vm-Architektur]
...
image::a-w-n_anthos-128-vsphere8_validation.png[A w n anthos 128 vsphere8-Validierung]
