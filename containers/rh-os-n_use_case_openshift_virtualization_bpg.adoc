...
Weitere Informationen zur Migration von VMs von vSphere finden Sie unter link:https://docs.netapp.com/us-en/netapp-solutions/containers/rh-os-n_use_case_openshift_virtualization_workflow_vm_migration_using_mtv.html["Workflows > Red hat OpenShift Virtualization with NetApp ONTAP"]
