...
. Weitere Informationen zum Erstellen und Wiederherstellen von Backups für VMs in OpenShift Virtualization, die auf der OpenShift Container-Plattform bereitgestellt werden, finden Sie unter link:rh-os-n_use_case_openshift_virtualization_dp_trident_protect.html["Hier"].
