...
link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=6462f4e4-2320-42d2-8d0b-b01200f00ccb["Mounten Sie Amazon FSX für ONTAP Volumes auf VMC SDDC"]
