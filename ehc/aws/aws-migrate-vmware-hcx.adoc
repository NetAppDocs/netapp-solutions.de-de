...
. Verwenden Sie ein vorhandenes VMC SDDC oder erstellen Sie nach diesem Vorgang ein neues SDDC https://docs.netapp.com/us-en/netapp-solutions/ehc/aws/aws-setup.html["Link von NetApp"^] Oder hier https://docs.vmware.com/en/VMware-Cloud-on-AWS/services/com.vmware.vmc-aws.getting-started/GUID-EF198D55-03E3-44D1-AC48-6E2ABA31FF02.html["Link zu VMware"^].
