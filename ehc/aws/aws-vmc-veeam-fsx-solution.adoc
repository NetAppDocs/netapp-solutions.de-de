...
summary:  
---
= Veeam Backup & Restore in VMware Cloud mit AWS FSX for ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
. Veeam benötigt spezielle TCP Ports für die Kommunikation zwischen Servern und den Komponenten in der Backup-Umgebung. Auf den Komponenten der Veeam Backup-Infrastruktur werden automatisch die erforderlichen Firewall-Regeln erstellt. Eine vollständige Liste der Anforderungen an den Netzwerkport finden Sie im Abschnitt Ports des https://["Veeam Backup and Replication User Guide for VMware vSphere"].
...
Nähere Informationen zu FSX für NetApp ONTAP finden Sie im https://["FSX for ONTAP Benutzerhandbuch"^].

Detaillierte Informationen zu Veeam Backup and Replication finden Sie im https://["Technische Dokumentation Des Veeam Help Center"^] Standort.

Hinweise zu Überlegungen und Einschränkungen bei der Verwendung von Veeam Backup and Replication mit VMware Cloud on AWS finden Sie unter https://["VMware Cloud on AWS und VMware Cloud on Dell EMC Support. Überlegungen und Einschränkungen"].
...
Informationen zur Dimensionierung der Anzahl von Proxy-Servern und zu deren Systemanforderungen finden Sie im https://["Veeam VMware vSphere Best Practice Guide"].
...
Weitere Informationen zu den Transportmodi finden Sie im https://["Veeam Backup and Replication User Guide for VMware vSphere"].
...
NOTE: Weitere Informationen zur Verwendung von FSX für ONTAP finden Sie im https://["FSX for ONTAP Benutzerhandbuch"^].
...
====
Weitere Informationen zum Durchführen von SQL Server-Wiederherstellungsvorgängen mit Veeam Explorer finden Sie im Abschnitt Microsoft SQL Server in der https://["Benutzerhandbuch Für Veeam Explorers"].
...
Weitere Informationen zur Wiederherstellung von Oracle-Datenbanken mit Veeam Explorer finden Sie im Abschnitt Oracle in der https://["Benutzerhandbuch Für Veeam Explorers"].
...
* https://["FSX for ONTAP Benutzerhandbuch"^]
* https://["Technische Dokumentation Des Veeam Help Center"^]
* https://["VMware Cloud auf AWS Unterstützung: Überlegungen und Einschränkungen"]
