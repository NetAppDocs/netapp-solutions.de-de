...
* Verwenden Sie ein vorhandenes softwaredefiniertes Google Cloud VMware Engine Datacenter (SDDC) oder erstellen Sie mithilfe dieses Modells eine Private Cloud https://docs.netapp.com/us-en/netapp-solutions/ehc/gcp/gcp-setup.html["Link von NetApp"^] Oder hier https://cloud.google.com/vmware-engine/docs/create-private-cloud["Google-Link"^].
