...
Eine Schritt-für-Schritt-Anleitung zum Einrichten von SnapCenter und Replizieren der Daten finden Sie unter https://docs.netapp.com/us-en/netapp-solutions/ehc/aws-guest-dr-config-snapmirror.html["Einrichtung der Replikation mit SnapCenter"]
