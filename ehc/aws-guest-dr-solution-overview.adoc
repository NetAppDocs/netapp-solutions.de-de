...
image:dr-vmc-aws-image1.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
link:aws-guest-dr-solution-prereqs.html["Anforderungen, Voraussetzungen und Planung der DR-Lösung"]
...
NOTE: Weitere Informationen zum Erstellen von SnapMirror Beziehungen mit FSX finden Sie im https://docs.aws.amazon.com/fsx/latest/ONTAPGuide/ONTAPGuide.pdf["FSX ONTAP – ONTAP-Benutzerhandbuch"^].
...
....
+
image:dr-vmc-aws-image11.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
....
+
image:dr-vmc-aws-image14.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
SnapCenter Software ist über die NetApp Support Site erhältlich und kann auf Microsoft Windows Systemen installiert werden, die sich entweder in einer Domäne oder Arbeitsgruppe befinden. Eine ausführliche Planungshilfe und Installationsanleitung finden Sie auf der  https://docs.netapp.com/us-en/snapcenter/install/requirements-to-install-snapcenter-server.html["NetApp Documentation Center"^] .
...
+
image:dr-vmc-aws-image18.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image19.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image20.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image21.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image22.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
image:dr-vmc-aws-image23.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
image:dr-vmc-aws-image24.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
image:dr-vmc-aws-image25.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image26.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image27.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]

. Fügen Sie Ihre Zugangsdaten ein, um auf das ONTAP Cluster zuzugreifen.
+
image:dr-vmc-aws-image28.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]

. Wählen Sie auf der Seite NAS Filer die gewünschten Protokolle zum Scannen aus und wählen Sie Weiter.
+
image:dr-vmc-aws-image29.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image30.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image31.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image32.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image33.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image34.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image35.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image37.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image38.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image39.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
[%collapsible%open]
====
SnapCenter stellt eine Web-Client-Schnittstelle zum Ausführen VON REST-API-Befehlen bereit. Informationen zum Zugriff auf die REST-APIs über Swagger finden Sie in der SnapCenter-Dokumentation unter https://docs.netapp.com/us-en/snapcenter/sc-automation/overview_rest_apis.html["Dieser Link"^].
...
+
image:dr-vmc-aws-image40.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]

. Erweitern Sie den Abschnitt „Auth“, und klicken Sie auf „Probieren Sie es aus“.
+
image:dr-vmc-aws-image41.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image42.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image43.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image44.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]

. Erweitern Sie den `/4.6/disasterrecovery/server/backup` Und klicken Sie auf „Probieren“.
+
image:dr-vmc-aws-image45.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image46.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
image:dr-vmc-aws-image47.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image48.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image49.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image50.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]

+
image:dr-vmc-aws-image51.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image52.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image53.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]

. Wählen Sie Amazon S3 als Objektspeichertyp aus.
+
image:dr-vmc-aws-image54.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]

. Wählen Sie aus der Liste der Amazon Cloud Storage Services Amazon S3 aus.
+
image:dr-vmc-aws-image55.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image56.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]

. Geben Sie auf der Bucket-Seite Datacenter, Bucket, Ordner und gewünschte Optionen ein. Klicken Sie Auf Anwenden.
+
image:dr-vmc-aws-image57.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image58.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image59.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]

. Nach Abschluss des Imports können Sie die VMs in das VMware Cloud Cluster wiederherstellen.
+
image:dr-vmc-aws-image60.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image61.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image62.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image63.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]

. Wählen Sie auf der Host-Seite den Ziel-ESXi-Host oder das Ziel-Cluster aus, auf dem die VM wiederhergestellt werden soll.
+
image:dr-vmc-aws-image64.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image65.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]

. Ordnen Sie auf der Seite Netzwerk die ursprünglichen Netzwerke auf der VM den Netzwerken im neuen Zielverzeichnis zu.
+
image:dr-vmc-aws-image66.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]

+
image:dr-vmc-aws-image67.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image68.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image69.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]

+
image:dr-vmc-aws-image70.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image71.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image72.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image73.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image74.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image75.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
image:dr-vmc-aws-image76.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
[%collapsible%open]
====
Um den Zugriff auf die sekundären Storage-Volumes, die auf der FSX ONTAP-Instanz gehostet werden, auf die Oracle-Server zu ermöglichen, müssen Sie zunächst die bestehende SnapMirror-Beziehung unterbrechen.
...
....
+
image:dr-vmc-aws-image77.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
....
+
image:dr-vmc-aws-image78.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]

. Aktualisieren Sie den Verbindungspfad im Amazon FSX Web-Client:
+
image:dr-vmc-aws-image79.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image80.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image81.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
+
image:dr-vmc-aws-image82.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]

+
image:dr-vmc-aws-image83.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
...
Nach erfolgreichem Abschluss des in dieser Lösung beschriebenen Failover-Prozesses setzen SnapCenter und Veeam die Backup-Funktionen in AWS wieder ein. FSX ONTAP wird nun als primärer Storage bezeichnet, wobei keine SnapMirror-Beziehungen mit dem ursprünglichen lokalen Datacenter vorhanden sind. Nachdem die normale Funktion wieder aufgenommen wurde, können Daten mit einem Prozess wie in dieser Dokumentation beschrieben in das lokale ONTAP Storage-System gespiegelt werden.

Wie auch in dieser Dokumentation beschrieben, können Sie SnapCenter konfigurieren, um die Applikationsdaten-Volumes von FSX ONTAP auf ein ONTAP Storage-System vor Ort zu spiegeln. Ähnlich lässt sich Veeam für die Replizierung von Backup-Kopien in Amazon S3 konfigurieren. Dazu wird ein Scale-out-Backup-Repository verwendet, damit diese Backups einem Veeam Backup-Server im lokalen Datacenter zugänglich sind.
...
FSX ONTAP für AWS ist eine solche Lösung, die eine nahtlose Integration mit SnapCenter und SyncMirror zur Replizierung von Applikationsdaten in die Cloud ermöglicht. Veeam Backup & Replication ist eine weitere bekannte Technologie, die sich gut in NetApp ONTAP Storage-Systeme integrieren lässt und Failover auf nativen vSphere Storage bietet.
...
+
link:index.html["NetApp Hybrid-Multi-Cloud mit VMware Lösungen"]

+
link:../index.html["NetApp Lösungen"]
