...
+
image::avs-register-create-pc-1.png[avs-Registrierung pc 1 erstellen]

+
image::avs-register-create-pc-2.png[avs-Registrierung pc 2 erstellen]
...
image::avs-register-create-pc-3.png[avs-Registrierung pc 3 erstellen]
...
image::avs-register-create-pc-4.png[avs-Registrierung pc 4 erstellen]
...
+
image::azure-connect-gateway-1.png[azure Connect Gateway 1]

. Geben Sie die Informationen für die neue vnet ein, oder aktualisieren Sie sie, und wählen Sie OK.


image::azure-connect-gateway-2.png[azure Connect Gateway 2]
...
image::azure-validate-network-1.png[azure Netzwerk validieren 1]

Nachdem die virtuelle Maschine bereitgestellt wurde, verwenden Sie die Option Verbinden, um auf RDP zuzugreifen.

image::azure-validate-network-2.png[azure Netzwerk validieren 2]
...
image::azure-validate-network-3.png[azure Netzwerk validieren 3]
...
image::azure-validate-network-4.png[azure Netzwerk validieren 4]

image::azure-validate-network-5.png[azure Netzwerk validieren 5]
