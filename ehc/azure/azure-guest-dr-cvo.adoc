...
[%collapsible]
====
Als ersten Schritt müssen Sie Cloud Volumes ONTAP auf Azure konfigurieren (https://["Verlinken"^]) Und replizieren Sie die gewünschten Volumen zu Cloud Volumes ONTAP mit den gewünschten Frequenzen und Snapshot-Aufbewahrung.
