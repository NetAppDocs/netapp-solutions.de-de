...
| link:containers/devops_with_netapp/dwn_solution_overview.html["DevOps mit NetApp Astra"] | link:containers/rh-os-n_videos_astra_control_flexclone.html["Video: Schnellere Software-Entwicklung mit Astra Control und NetApp FlexClone Technologie"] 
