...
---
= Bereitstellen von Microsoft Hyper-V auf NetApp-Speicher: Migrationsskript
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Dieser Abschnitt enthält ein PowerShell Skript, das zur Migration mit FlexClone verwendet werden kann.
