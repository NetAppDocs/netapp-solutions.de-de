...
summary: NetApp erhielt die Anforderung, nach mehrfach vorhandenen Dateien auf einzelnen Volumes oder mehreren Volumes zu suchen. NetApp hat folgende Lösung bereitgestellt. 
---
...
link:xcp-bp-using-the-xcp-data-mover-to-migrate-large-files.html["Zurück: Mit dem XCP Data Mover große Dateien migrieren."]

[role="lead"]
NetApp erhielt die Anforderung, nach mehrfach vorhandenen Dateien auf einzelnen Volumes oder mehreren Volumes zu suchen. NetApp hat folgende Lösung bereitgestellt.
...
....
link:xcp-bp-specific-date-based-scan-and-copy-of-data.html["Weiter: Spezifische datumbasierte Scan und Kopie von Daten."]
