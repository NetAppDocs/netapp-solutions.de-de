...
link:xcp-bp-duplicate-files.html["Früher: Doppelte Dateien."]

[role="lead"]
Diese Lösung basiert auf einem Kunden, der Daten basierend auf einem bestimmten Datum kopieren muss. Überprüfen Sie folgende Details:
...
c:\XCP>
....
link:xcp-bp-creating-a-csv-file-from-smb-cifs-share.html["Als Nächstes: Erstellen einer CSV-Datei aus SMB/CIFS-Freigabe."]
