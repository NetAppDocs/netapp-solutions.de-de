...
. Klicken Sie im Bucket auf *Upload* > *Dateien hinzufügen* und wählen Sie *paramiko.zip* und *Requests.zip* aus dem geklonten GitHub-Repository auf Ihrem System aus.
+
