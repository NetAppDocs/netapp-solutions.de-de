...
link:cdm-fod-solution-technology.html["Früher: Lösungstechnologie."]
...
. Erstellen Sie eine neue Arbeitsumgebung, wählen Sie den Cloud-Provider und den Typ der Cloud Volumes ONTAP-Instanz (z. B. Single-CVO, Hochverfügbarkeit oder Amazon FSxN für ONTAP) aus.
...
link:cdm-fod-conclusion.html["Weiter: Fazit."]
