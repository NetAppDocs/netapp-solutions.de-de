...
Der Kern der Confluent Platform ist https://["Kafka"^], Die beliebteste verteilte Open Source Streaming-Plattform. Kafka bietet u. a. folgende zentrale Funktionen:
