...
[%collapsible]
====
NetApp empfiehlt das SnapCenter UI-Tool für das Management der in der Azure-Cloud implementierten Oracle-Datenbank. Eine detaillierte Lösungsdokumentation wird in Kürze verfügbar sein.
