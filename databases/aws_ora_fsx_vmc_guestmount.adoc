...
---
= TR-4979: Vereinfachtes, selbstverwaltetes Oracle in VMware Cloud on AWS mit FSX ONTAP über Gast-Mounted
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Das Testen und Validieren dieser Lösung wurde in einer Lab-Umgebung mit VMC auf AWS durchgeführt, die möglicherweise nicht mit der endgültigen Implementierungsumgebung übereinstimmt. Weitere Informationen finden Sie im Abschnitt <<Key Factors for Deployment Consideration>>.
...
. Optional bietet NetApp auch mehrere Automatisierungs-Toolkits zur Ausführung von Oracle-Bereitstellung und -Konfiguration, falls zutreffend. Siehe link:https://docs.netapp.com/us-en/netapp-solutions/databases/index.html["Toolkits für DB-Automatisierung"^] Finden Sie weitere Informationen.
