...
. Bewertung und *Hinzufügen*. Bild::snapctr_svcs_Credential_04-Azure.png[„Screenshot, der diesen Schritt in der GUI zeigt.“]
. Möglicherweise müssen Sie auch ein *Marketplace-Abonnement* mit den Zugangsdaten verknüpfen. Bild::snapctr_svcs_Credential_05-Azure.png[„Screenshot, der diesen Schritt in der GUI zeigt.“]
...
+
image::snapctr_svcs_restore_01-azure.png[Snapctr svcs stellt 01 Azure wieder her]
