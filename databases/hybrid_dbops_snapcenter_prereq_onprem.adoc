...
link:hybrid_dbops_snapcenter_prerequisite.html["Zurück: Konfiguration der Voraussetzungen."]
...
link:hybrid_dbops_snapcenter_prereq_cloud.html["In der nächsten Richtung: Public Cloud."]
