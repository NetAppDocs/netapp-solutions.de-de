...
Folgen Sie diesen Anweisungen, um Ihren Ansible-Steuerungsknoten für RedHat- oder CentOS-Maschinen einzurichten: link:../automation/automation_rhel_centos_setup.html["Redhat/CentOS Ansible Controller-Setup"^].
Befolgen Sie diese Anweisungen, um Ihren Ansible-Steuerungsknoten für Ubuntu oder Debian-Maschinen einzurichten: link:../automation/automation_ubuntu_debian_setup.html["Ubuntu/Debian Ansible-Controller-Setup"^].
