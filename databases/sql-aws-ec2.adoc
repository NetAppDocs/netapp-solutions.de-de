...
| Best Practices In Sich Vereint 
 ...
 a| 
* Für optimale Storage-Performance stellen Sie eine 1,5-mal so große Kapazität eines Filesystems für die gesamte Datenbanknutzung bereit.
...
|===
Ausführliche Informationen finden Sie unter Speicherplatz und Größenanforderung (https://docs.netapp.com/us-en/snapcenter/install/reference_space_and_sizing_requirements.html)[]
