...
[%collapsible]
====
Melden Sie sich bei den bereitgestellten Voraussetzungen als Root-Benutzer bei der EC2-Instanz an, um den Linux-Kernel für die Oracle-Installation zu konfigurieren.
...
[%collapsible]
====
Stellen Sie drei Volumes über die FSX-Konsole bereit, um die binären-, Daten- und Protokolldateien der Oracle-Datenbank zu hosten.
...
. Melden Sie sich über SSH als ec2-User bei der EC2-Instanz an. Wechseln Sie dann zu Ihrem SSH-Schlüssel und der IP-Adresse der EC2-Instanz.
+
....
...
....
. Ändern Sie die Geräteeigentümerschaft in `oracle:oinstall`.
+
....
...
....
. Starten Sie als Oracle-Benutzer `gridSetup.sh` Für die Installation der Netzinfrastruktur.
+
....
...
....
. Wenn Sie die Meldung „[INS-43080]“ erhalten haben, dass einige der Konfigurationsassistenten fehlgeschlagen, abgebrochen oder übersprungen wurden, führen Sie den folgenden Befehl als oracle-Benutzer aus, um zu überprüfen, ob die RESSOURCE DER DATENDISKETTE erstellt wurde.
+
....
bin/crsctl stat res -t
....
. Wenn die DATENDATENTRÄGER-Gruppe nicht erstellt wurde, laden Sie den multipathd als root-Benutzer neu.
+
....
systemctl restart multipathd
....
. Erstellen Sie als oracle-Benutzer eine DATENDISK-Gruppe, wenn sie während der Grid-Installation nicht erstellt wurde.
+
....
...
....
. Führen Sie die reine Software-Installation im Hintergrund aus.
+
....
 ./runInstaller -applyRU /tmp/archive/34765931/ -silent -ignorePrereqFailure -responseFile /tmp/archive/dbinstall.rsp
....
. Führen Sie die aus `root.sh` Skript nach der Installation nur für Software.
+
....
/u01/app/oracle/product/19.0.0/db1/root.sh
....
. Erstellen Sie die `dbca.rsp` Datei mit folgenden Einträgen:
+
....
...
....
. Validieren von Oracle Neustart der HA-Services nach der DB-Erstellung
+
....
