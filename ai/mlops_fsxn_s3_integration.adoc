...
Klicken Sie unten links auf den orangefarbenen Button *Notizbuchinstanz erstellen*.
+
...
.. Lassen Sie andere Einträge standardmäßig und klicken Sie auf die orangefarbene Schaltfläche *Weiter* unten links.
+
image:mlops_fsxn_s3_integration_10.png["Fehler: Konfiguration bestätigen"]

.. Klicken Sie auf die orangefarbene Schaltfläche *Dateisystem erstellen* unten links auf der Review-Seite.
+
