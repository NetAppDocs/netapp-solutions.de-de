...
link:https://www.netapp.com/pdf.html?item=/media/19399-tr-4851.pdf["TR-4851: NetApp StorageGRID Data Lake für Workloads für das autonome Fahren – Lösungsdesign"^]
