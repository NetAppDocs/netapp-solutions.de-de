...
link:a400-thinksystem-introduction.html["Zurück: Einführung."]
...
Die NetApp AFF A400 ist ein NVMe-Flash-Storage-System für mittelständische Unternehmen, die auf Hardware der FAS2650 und SSD-Flash-Medien basieren.
...
Zu den Midrange-Funktionen des NetApp AFF A400 Storage-Systems gehören:

* Maximale effektive Kapazität: 702,7 PB
...
link:a400-thinksystem-test-plan.html["Als Nächstes: Testplan"]
