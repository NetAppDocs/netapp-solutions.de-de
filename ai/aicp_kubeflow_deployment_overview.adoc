...
. Sie haben bereits einen funktionierenden Kubernetes-Cluster und führen eine Version von Kubernetes aus, die von Kubeflow unterstützt wird. Eine Liste der unterstützten Versionen finden Sie im https://["Offizielle Dokumentation von Kubeflow"^].
...
NOTE: Alternativ können Sie Kubeflow manuell bereitstellen, indem Sie dem folgen https://["Installationsanweisungen"^] In der offiziellen Kubeflow Dokumentation

. Implementieren Sie Kubeflow in Ihrem Cluster, indem Sie den folgen https://["Anweisungen zur Bereitstellung von Kubeflow"^] Auf der NVIDIA DeepOps GitHub Website.
...
+
Der Standardbenutzername lautet `admin@kubeflow.org`, Und das Standardpasswort lautet `12341234`. Um weitere Benutzer zu erstellen, befolgen Sie die Anweisungen im https://["Offizielle Dokumentation von Kubeflow"^].
