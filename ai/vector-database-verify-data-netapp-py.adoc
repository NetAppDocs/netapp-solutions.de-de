...
summary: verify_data_netapp.py - Vektordatenbank für NetApp 
---
...
[role="lead"]
Dieser Abschnitt enthält ein Beispiel-Python-Skript, das zur Validierung der Vektordatenbank in der NetApp-Vektordatenbank-Lösung verwendet werden kann.
