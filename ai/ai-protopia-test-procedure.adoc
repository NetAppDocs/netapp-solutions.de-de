...
+
** Anweisungen zur Installation und Konfiguration finden Sie https://["Hier"^].


* NetApp DataOps Toolkit für Kubernetes
+
** Installationsanweisungen finden Sie https://["Hier"^].
...
....
. Sie können Ihr Modell auf dem neuen persistenten Volume in einem speichern https://["Formatieren"^] Das wird vom NVIDIA Triton Inferenz Server erkannt.
+
