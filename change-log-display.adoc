...
[cols="10%, 30%, 60%"]
|===
| *Datum* | *Lösungsbereich* | *Beschreibung der Änderung* / Tag::ent-db[] 
...
| 05/14/2024 | Einheitliche | Migration von VMs zu Amazon EC2 unter Verwendung von FSxN-Inhalten hinzugefügt 
